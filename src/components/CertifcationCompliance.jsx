...
const CertifcationCompliance = () => {
    return (
        <div className='lg:rounded-t-[100px]  bg-primary-green-black pb-8'>
            <p className='flex justify-center text-green-200 2xl:text-[70px] lg:text-[50px] text-[30px] py-8 font-neulis font-light'>CERTIFCATIONS & COMPLIANCE</p>
            <p className='flex lg:justify-center text-white font-neulis lg:px-16 px-4'>Megas Agriculture Limited is a fully certified, internationally compliant agribusiness and export company. We uphold the highest standards of transparency, sustainability, and quality assurance across our operations.</p>
