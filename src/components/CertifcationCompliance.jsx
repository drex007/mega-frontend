    ...
    return (
        ...
        >
            <div className='lg:rounded-t-[100px]  bg-primary-green-black pb-8'>
                ...
                <p className='flex lg:justify-center text-white font-neulis lg:px-16 px-4 lg:text-[15px] text-[15px]'>Megas Agriculture Limited is a fully certified, internationally compliant agribusiness and export company. We uphold the highest standards of transparency, sustainability, and quality assurance across our operations.</p>
                ...
                <div className='lg:p-8 p-4'>
                    <div className='lg:flex grid grid-cols-1 justify-between p-4'>
                        ...
                        <div className=' hidden  lg:w-2/6 2xl:2/5 lg:flex items-center space-x-4'>
                            <img src={cert4} />
                            <p className='text-white font-neulis lg:text-[15px] text-[14px]'>Licensed Agro-Exporter with the Nigerian Export Promotion Council (NEPC)</p>
                        </div>
                ...
                <div className='lg:p-16 p-4'>
                    ...
                    <div className='font-neulis text-white lg:text-[15px] text-[14px]'>
