    ...
    return (
        <div className='w-full bg-black text-white font-neulis'>
            ...
            <div className='p-8'>
                ...
                <p className='lg:text-[20px] text-[15px]'>Operating from Nigeria and Canada, Megas Agriculture connects African farmers to premium international markets. Our expanding footprint enables us to deliver consistent quality across:
                ...
                <p className='py-4 lg:text-[20px] text-[15px]'>Building Bridges Between Producers & Global Buyers By digitizing supply chains, verifying quality at the source, and empowering farmers with market access, we make agro exports seamless, traceable, and profitable for all stakeholders.</p>
